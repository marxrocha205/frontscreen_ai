    ...
    ws.onmessage = (event) => {
      ...
      switch (data.type) {
        ...
        case 'error':
          ...
          if (data.message && (data.message.includes('Créditos insuficientes') || data.message.includes('Limite') || data.message.includes('crie uma conta') || data.message.includes('excedido'))) {
