      ...
      <DialogContent className="sm:max-w-md bg-[#121212] border-zinc-800/50 text-zinc-100 p-8 rounded-3xl shadow-2xl backdrop-blur-xl">
        ...
        <div className="space-y-4">
           <Button 
             ...
             className="w-full bg-zinc-900/50 border-zinc-800 text-zinc-200 hover:bg-zinc-800 hover:text-white rounded-xl h-12 justify-center font-semibold transition-all duration-200 group"
           >
           ...
           <Button 
             variant="outline" 
             onClick={() => router.push('/login')} 
             className="w-full bg-zinc-900/50 border-zinc-800 text-zinc-200 hover:bg-zinc-800 hover:text-white rounded-xl h-12 justify-center font-semibold transition-all duration-200"
           >
             <div className="flex items-center justify-center gap-3">
